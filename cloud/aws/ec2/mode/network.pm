...
Example: 
perl centreon_plugins.pl --plugin=cloud::aws::plugin --custommode=paws --mode=ec2-asg-network --region='eu-west-1' --type='asg' --instance='centreon-middleware' --filter-metric='Packets' --statistic='sum' ---critical-networkpacketsout-sum='10' --verbose
